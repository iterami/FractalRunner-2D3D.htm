...
function setmode(newmode, newgame){
    ...
    // main menu mode
        ...
        get('page').innerHTML = '<div style=display:inline-block;text-align:left;vertical-align:top><div class=c><a href=/><b>FractalRunner</b></a></div><hr><div class=c><ol><li><a onclick=setmode(1,1)>Walled Corridor</a></ol></div></div><div style="border-left:8px solid #222;display:inline-block;text-align:left"><div class=c><input disabled size=3 style=border:0 value=ESC>Main Menu<br><input id=movement-keys maxlength=2 size=3 value='
